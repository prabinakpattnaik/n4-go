...
func TestIEOuterHeaderCreation(t *testing.T) {
	// GTP-U/UDP/IPv4 (5/1)
	//TEID
	outerHeaderCreation := dt.OctetString([]byte{0x01, 0x00, 0x00, 0x00, 0xff, 0x08, 0x08, 0x08, 0x8})
	...
	ba := []byte{0x00, 0x54, 0x00, 0x09, 0x01, 0x00, 0x00, 0x00, 0xff, 0x08, 0x08, 0x08, 0x08}
...
func TestNewOuterHeaderCreation(t *testing.T) {
	...
	a := []byte{0x01, 0x00, 0x00, 0x00, 0x64, 0x08, 0x08, 0x08, 0x08}
