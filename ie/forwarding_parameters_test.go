...
func TestForwardingParameters(t *testing.T) {
	...
	ba := []byte{0x00, 0x2a, 0x00, 0x01, 0x01, 0x00, 0x54, 0x00, 0x0a, 0x01, 0x00, 0x00, 0x00, 0x00, 0x64, 0x08, 0x08, 0x08, 0x08}
...
func TestForwardingParametersIEInFAR(t *testing.T) {
	...
	ba := []byte{0x00, 0x2a, 0x00, 0x01, 0x00,
		...
		0x00, 0x54, 0x00, 0x0a, 0x01, 0x00, 0x00, 0x00, 0x00, 0x64, 0x08, 0x08, 0x08, 0x08}
