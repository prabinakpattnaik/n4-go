...
func NewPDI(sourceInterface, localFTEID, networkInstance, ueIPAddress, trafficEndpointID, sdffilter, applicaitonID, ethernetPDUSessionInformation, ethernetPacketFilter, qfi, framedRoute, frameRouting, frameIPv6Route *InformationElement) *PDIWithIE {
	return &PDIWithIE{
...
func (p PDIWithIE) Serialize() ([]byte, error) {
