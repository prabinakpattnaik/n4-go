...
func TestPFCPSessionModificationRequest(t *testing.T) {
	...
	updatePDR := ie.NewUpdatePDR(&pdrid, nil, &precedence, &pdiIE, &farID, nil, nil, nil, nil)
	...
	updateFAR := ie.NewUpdateFAR(&farID, &a, &fpIE, nil, nil)
	...
	smr := NewPFCPSessionModificationRequest(pfcpHeader, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, &updatePDREle, &updateFAREle, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	...
	ba := []byte{0x21, 0x34, 0x00, 0x60,
		...
		0x00, 0x0a, 0x00, 0x24, //IECreateFAR
		0x00, 0x6c, 0x00, 0x04, 0x00, 0x00, 0x00, 0x64, //IEFARID
		0x00, 0x2c, 0x00, 0x01, 0x02, //IEApplyAction
		0x00, 0x04, 0x00, 0x13, //IEForwarding Parameters
		0x00, 0x2a, 0x00, 0x01, 0x00, //IEDestination Interface
		0x00, 0x54, 0x00, 0x0a, 0x01, 0x00, 0x00, 0x00, 0x00, 0x64, 0x08, 0x08, 0x08, 0x08, //IEOuterHeaderCreation
	}
